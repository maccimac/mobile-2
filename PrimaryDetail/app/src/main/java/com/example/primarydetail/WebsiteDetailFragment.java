...
import com.example.primarydetail.databinding.FragmentWebsiteDetailBinding;
...
//        mTextView = binding.websiteDetail;
    ...
    private void updateContent() {
        if (mItem != null) {
//            binding.websiteDetail.setWebViewClient(
//                    new WebViewClient(){
//                        @Override
//                        public boolean shouldOverrideLoading(
//                                WebView view,
